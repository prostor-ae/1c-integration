import { callShopify } from "@/app/lib/shopify-client";
...
export async function processCollection(collectionId: string) {
  ...
  try {
    ...
    const sortedProducts = allProducts.sort((a, b) => {
      const sortA = a.metafield ? parseInt(a.metafield.value, 10) : 500;
      const sortB = b.metafield ? parseInt(b.metafield.value, 10) : 500;
      return sortA - sortB;
    });
